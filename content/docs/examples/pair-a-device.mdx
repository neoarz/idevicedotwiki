...
- [`tools/src/pair_host.rs`](https://github.com/jkcoxson/idevice/blob/e3a6066/tools/src/pair_host.rs)
- [`tools/src/pair_apple_tv.rs`](https://github.com/jkcoxson/idevice/blob/e3a6066/tools/src/pair_apple_tv.rs)
- [`cpp/examples/pair_host.cpp`](https://github.com/jkcoxson/idevice/blob/e3a6066/cpp/examples/pair_host.cpp)
