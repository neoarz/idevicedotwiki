...
- [`tools/src/ideviceinstaller.rs`](https://github.com/jkcoxson/idevice/blob/e3a6066/tools/src/ideviceinstaller.rs)
- [`idevice/src/utils/installation/mod.rs`](https://github.com/jkcoxson/idevice/blob/e3a6066/idevice/src/utils/installation/mod.rs)
- [`ffi/examples/ipa_installer.c`](https://github.com/jkcoxson/idevice/blob/e3a6066/ffi/examples/ipa_installer.c)
- [`cpp/examples/installation_proxy.cpp`](https://github.com/jkcoxson/idevice/blob/e3a6066/cpp/examples/installation_proxy.cpp)
