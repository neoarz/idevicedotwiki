...
- [`tools/src/syslog_relay.rs`](https://github.com/jkcoxson/idevice/blob/master/tools/src/syslog_relay.rs)
- [`cpp/examples/syslog_relay.cpp`](https://github.com/jkcoxson/idevice/blob/master/cpp/examples/syslog_relay.cpp)
