...
| Area | What it does |
|---|---|
| Process control | Lists, launches, and controls processes through DVT. |
...
- [`services/dvt/`](https://github.com/jkcoxson/idevice/tree/master/idevice/src/services/dvt)
...
- [`services/dvt/xctest/`](https://github.com/jkcoxson/idevice/tree/master/idevice/src/services/dvt/xctest)
- [`services/wda.rs`](https://github.com/jkcoxson/idevice/blob/master/idevice/src/services/wda.rs)
- [`services/wda_bridge.rs`](https://github.com/jkcoxson/idevice/blob/master/idevice/src/services/wda_bridge.rs)
