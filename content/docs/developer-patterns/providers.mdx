...
- [`idevice/src/provider.rs`](https://github.com/jkcoxson/idevice/blob/e3a6066/idevice/src/provider.rs)
...
- [`tools/src/common.rs`](https://github.com/jkcoxson/idevice/blob/e3a6066/tools/src/common.rs)
