...
- [`idevice/src/services/syslog_relay.rs`](https://github.com/jkcoxson/idevice/blob/master/idevice/src/services/syslog_relay.rs)
...
- [`idevice/src/services/dvt/mod.rs`](https://github.com/jkcoxson/idevice/blob/master/idevice/src/services/dvt/mod.rs)
- [`idevice/src/services/core_device/app_service.rs`](https://github.com/jkcoxson/idevice/blob/master/idevice/src/services/core_device/app_service.rs)
- [`idevice/src/services/core_device_proxy.rs`](https://github.com/jkcoxson/idevice/blob/master/idevice/src/services/core_device_proxy.rs)
