...
- [`idevice/src/services/installcoordination_proxy.rs`](https://github.com/jkcoxson/idevice/blob/e3a6066/idevice/src/services/installcoordination_proxy.rs)
- [`tools/src/installcoordination_proxy.rs`](https://github.com/jkcoxson/idevice/blob/e3a6066/tools/src/installcoordination_proxy.rs)
